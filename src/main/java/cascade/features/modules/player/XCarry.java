...
extends Module {
    ...
    public void onUpdate() {
        ...
        if (this.autoDuelOn) {
            ...
            if (this.autoDuelOn) {
                if (!this.obbySlotDone && !XCarry.mc.thePlayer.inventory.getStackInSlot((int)(this.obbySlot.getValue().intValue() - 1)).field_190928_g) {
                    this.addTasks(36 + this.obbySlot.getValue() - 1);
                }
                this.obbySlotDone = true;
                if (!this.slot1done && !((Slot)XCarry.mc.thePlayer.inventoryContainer.inventorySlots.get((int)this.slot1.getValue().intValue())).getStack().field_190928_g) {
                    this.addTasks(this.slot1.getValue());
                }
                this.slot1done = true;
                if (!this.slot2done && !((Slot)XCarry.mc.thePlayer.inventoryContainer.inventorySlots.get((int)this.slot2.getValue().intValue())).getStack().field_190928_g) {
                    this.addTasks(this.slot2.getValue());
                }
                this.slot2done = true;
                if (!this.slot3done && !((Slot)XCarry.mc.thePlayer.inventoryContainer.inventorySlots.get((int)this.slot3.getValue().intValue())).getStack().field_190928_g) {
