...
extends Module {
    ...
    public void onPacketSend(PacketEvent.Send e) {
        ...
        if (e.getPacket() instanceof CPacketPlayer && !AntiAim.mc.thePlayer.func_184587_cr() && !AntiAim.mc.gameSettings.keyBindUseItem.getIsKeyPressed()) {
    ...
    float angleCalc() {
        double forward = AntiAim.mc.thePlayer.movementInput.field_192832_b;
