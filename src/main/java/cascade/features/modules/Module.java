...
extends Feature {
    ...
    public void enable() {
        ...
        if (this.module.shouldNotify()) {
            TextComponentString text = new TextComponentString((ClientManagement.getInstance().toggleName.getValue() != false ? Cascade.chatManager.getClientMessage() + " " : "") + ChatFormatting.RESET + ChatFormatting.BOLD + this.module.getName() + ChatFormatting.GREEN + " enabled.");
    ...
    public void disable() {
        ...
        this.onDisable();
        if (this.module.shouldNotify()) {
            TextComponentString text = new TextComponentString((ClientManagement.getInstance().toggleName.getValue() != false ? Cascade.chatManager.getClientMessage() + " " : "") + ChatFormatting.RESET + ChatFormatting.BOLD + this.module.getName() + ChatFormatting.RED + " disabled.");
            Module.mc.ingameGUI.getChatGUI().printChatMessageWithOptionalDeletion((ITextComponent)text, 1);
        }
