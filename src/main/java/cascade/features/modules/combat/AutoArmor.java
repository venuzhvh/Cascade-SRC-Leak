...
extends Module {
    ...
    public void onTick() {
        ...
        if (this.taskList.isEmpty()) {
            ...
            if ((chest = AutoArmor.mc.thePlayer.inventoryContainer.getSlot(6).getStack()).getItem() == Items.field_190931_a) {
                if (this.taskList.isEmpty()) {
            ...
            } else if (this.elytraOn && chest.getItem() != Items.field_185160_cR && this.elytraTimer.passedMs(500L)) {
                if (this.taskList.isEmpty()) {
                    slot2 = InventoryUtil.findItemInventorySlot(Items.field_185160_cR, false, XCarry.getInstance().isOn());
                    if (slot2 != -1) {
            ...
            } else if (!this.elytraOn && chest.getItem() == Items.field_185160_cR && this.elytraTimer.passedMs(500L) && this.taskList.isEmpty()) {
            ...
            if ((legging = AutoArmor.mc.thePlayer.inventoryContainer.getSlot(7).getStack()).getItem() == Items.field_190931_a && (slot3 = InventoryUtil.findArmorSlot(EntityEquipmentSlot.LEGS, this.curse.getValue(), XCarry.getInstance().isOn())) != -1) {
                this.getSlotOn(7, slot3);
            }
            if ((feet = AutoArmor.mc.thePlayer.inventoryContainer.getSlot(8).getStack()).getItem() == Items.field_190931_a && (slot4 = InventoryUtil.findArmorSlot(EntityEquipmentSlot.FEET, this.curse.getValue(), XCarry.getInstance().isOn())) != -1) {
