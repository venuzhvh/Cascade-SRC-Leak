...
extends Module {
    ...
    public void renderEntityStatic(Entity entityIn, float partialTicks, boolean p_188388_3_) {
        ...
        mc.func_175598_ae().func_188391_a(entityIn, d0 - PopChams.mc.func_175598_ae().viewerPosX, d1 - PopChams.mc.func_175598_ae().viewerPosY, d2 - PopChams.mc.func_175598_ae().viewerPosZ, f, partialTicks, p_188388_3_);
    }
