    ...
    private static class EntityListener {
        ...
        private void render() {
            ...
            for (Entity e : Util.mc.theWorld.loadedEntityList) {
                ...
                bound.func_178787_e(new Vec3d(0.0, (double)e.height + 0.2, 0.0));
        ...
        private Vec3d getEntityRenderPosition(Entity entity) {
            ...
            double x = entity.lastTickPosX + (entity.posX - entity.lastTickPosX) * partial - Util.mc.func_175598_ae().viewerPosX;
            double y = entity.lastTickPosY + (entity.posY - entity.lastTickPosY) * partial - Util.mc.func_175598_ae().viewerPosY;
            double z = entity.lastTickPosZ + (entity.posZ - entity.lastTickPosZ) * partial - Util.mc.func_175598_ae().viewerPosZ;
