...
extends Module {
    ...
    public void onPacketSend(PacketEvent.Send e) {
        ...
        if (this.noPistonPush.getValue().booleanValue() && (e.getPacket() instanceof CPacketPlayer.Position || e.getPacket() instanceof CPacketPlayer.PositionRotation)) {
            ...
            if (PlayerUtil.isPushable(NoSlow.mc.thePlayer.posX, NoSlow.mc.thePlayer.posY, NoSlow.mc.thePlayer.posZ)) {
                ...
                NoSlow.mc.thePlayer.func_174826_a(NoSlow.mc.thePlayer.func_174813_aQ().offset(0.00625 * Math.cos(Math.toRadians(NoSlow.mc.thePlayer.rotationYaw + 90.0f)), 0.0, 0.00625 * Math.sin(Math.toRadians(NoSlow.mc.thePlayer.rotationYaw + 90.0f))));
            }
        }
    }
    ...
    public void onInputUpdate(InputUpdateEvent e) {
        ...
        if (NoSlow.mc.thePlayer.func_184587_cr() && !NoSlow.mc.thePlayer.func_184218_aH()) {
            if (e.getMovementInput().field_192832_b == 2.0f) {
                // empty if block
            }
