...
extends Button {
    ...
    public static void drawLeftGradientRect(int left, int top, int right, int bottom, int startColor, int endColor) {
        ...
        builder.func_181662_b((double)right, (double)top, 0.0).func_181666_a((float)(endColor >> 24 & 0xFF) / 255.0f, (float)(endColor >> 16 & 0xFF) / 255.0f, (float)(endColor >> 8 & 0xFF) / 255.0f, (float)(endColor >> 24 & 0xFF) / 255.0f).func_181675_d();
        builder.func_181662_b((double)left, (double)top, 0.0).func_181666_a((float)(startColor >> 16 & 0xFF) / 255.0f, (float)(startColor >> 8 & 0xFF) / 255.0f, (float)(startColor & 0xFF) / 255.0f, (float)(startColor >> 24 & 0xFF) / 255.0f).func_181675_d();
        builder.func_181662_b((double)left, (double)bottom, 0.0).func_181666_a((float)(startColor >> 16 & 0xFF) / 255.0f, (float)(startColor >> 8 & 0xFF) / 255.0f, (float)(startColor & 0xFF) / 255.0f, (float)(startColor >> 24 & 0xFF) / 255.0f).func_181675_d();
        builder.func_181662_b((double)right, (double)bottom, 0.0).func_181666_a((float)(endColor >> 24 & 0xFF) / 255.0f, (float)(endColor >> 16 & 0xFF) / 255.0f, (float)(endColor >> 8 & 0xFF) / 255.0f, (float)(endColor >> 24 & 0xFF) / 255.0f).func_181675_d();
        tessellator.draw();
    ...
    public static void drawGradientRect(float left, float top, float right, float bottom, int startColor, int endColor, boolean hovered) {
        ...
        bufferbuilder.func_181662_b((double)right, (double)top, 0.0).func_181666_a(c1, c2, c3, c).func_181675_d();
        bufferbuilder.func_181662_b((double)left, (double)top, 0.0).func_181666_a(c1, c2, c3, c).func_181675_d();
        bufferbuilder.func_181662_b((double)left, (double)bottom, 0.0).func_181666_a(c5, c6, c7, c4).func_181675_d();
        bufferbuilder.func_181662_b((double)right, (double)bottom, 0.0).func_181666_a(c5, c6, c7, c4).func_181675_d();
        tessellator.draw();
        GlStateManager.func_179103_j((int)7424);
        GlStateManager.func_179084_k();
        GlStateManager.func_179141_d();
