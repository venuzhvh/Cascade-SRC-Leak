...
extends CFont {
    ...
    public float drawString(String text, double x, double y, int color, boolean shadow) {
        ...
        if (render) {
            ...
            GlStateManager.func_179144_i((int)this.tex.getGlTextureId());
            ...
            for (int i = 0; i < size; ++i) {
                ...
                if (character == '\u00a7' && i < size) {
                    ...
                    if (colorIndex < 16) {
                        ...
                        bold = true;
                        if (italic) {
                            GlStateManager.func_179144_i((int)this.texItalicBold.getGlTextureId());
                            currentData = this.boldItalicChars;
                        } else {
                            GlStateManager.func_179144_i((int)this.texBold.getGlTextureId());
                        ...
                        if (bold) {
                            ...
                            GlStateManager.func_179144_i((int)this.texItalic.getGlTextureId());
