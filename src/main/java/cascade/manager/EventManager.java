...
extends Feature {
    ...
    public void onPacketReceive(PacketEvent.Receive event) {
        ...
        if (event.getPacket() instanceof SPacketEntityStatus && (packet = (SPacketEntityStatus)event.getPacket()).func_149160_c() == 35 && packet.func_149161_a((World)EventManager.mc.theWorld) instanceof EntityPlayer) {
            EntityPlayer player = (EntityPlayer)packet.func_149161_a((World)EventManager.mc.theWorld);
